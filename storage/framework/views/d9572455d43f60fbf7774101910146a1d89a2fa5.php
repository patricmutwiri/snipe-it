          ...
          <div class="form-group <?php echo e($errors->has('asset_maintenance_type') ? ' has-error' : ''); ?>">
              ...
              <div class="col-md-7<?php echo e((\App\Helpers\Helper::checkIfRequired($item, 'asset_maintenance_type')) ? ' required' : ''); ?>">
                  <?php echo e(Form::select('asset_maintenance_type', $assetMaintenanceType , Input::old('asset_maintenance_type', $item->asset_maintenance_type), ['class'=>'select2', 'style'=>'min-width:350px'])); ?>

                  <?php echo $errors->first('asset_maintenance_type', '<span class="alert-msg"><i class="fa fa-times"></i> :message</span>'); ?>
