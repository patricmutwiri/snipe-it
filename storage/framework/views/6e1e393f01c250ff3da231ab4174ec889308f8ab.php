          ...
          <?php endif; ?>
            ...
            <div class="form-group <?php echo e($errors->has('name') ? 'error' : ''); ?>">
              ...
              <div class="col-md-8">
                ...
                value="<?php echo e(Input::old('name', $asset->name)); ?>"/>
            ...
            <div class="form-group <?php echo e($errors->has('status_id') ? 'error' : ''); ?>">
              <?php echo e(Form::label('name', trans('admin/hardware/form.status'), array('class' => 'col-md-3 control-label'))); ?>

              <div class="col-md-7 required">
                <?php echo e(Form::select('status_id', $statusLabel_list, '', array('class'=>'select2', 'style'=>'width:100%','id' =>'modal-statuslabel_types'))); ?>

                <?php echo $errors->first('status_id', '<span class="alert-msg"><i class="fa fa-times"></i> :message</span>'); ?>

              </div>
            </div>

            <?php echo $__env->make('partials.forms.edit.location-select', ['translated_name' => trans('general.location'), 'fieldname' => 'location_id', 'help_text' => ($asset->defaultLoc) ? 'You can choose to check this asset in to a location other than the default location of '.$asset->defaultLoc->name.' if one is set.' : null], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            ...
            <div class="form-group<?php echo e($errors->has('checkin_at') ? ' has-error' : ''); ?>">
              ...
              <div class="input-group col-md-5 required">
                <div class="input-group date" data-provide="datepicker" data-date-format="yyyy-mm-dd"  data-autoclose="true">
                  <input type="text" class="form-control" placeholder="<?php echo e(trans('general.select_date')); ?>" name="checkin_at" id="checkin_at" value="<?php echo e(Input::old('checkin_at', date('Y-m-d'))); ?>">
              ...
              <div class="form-group <?php echo e($errors->has('note') ? 'error' : ''); ?>">
                ...
                <div class="col-md-8">
                  ...
                  name="note"><?php echo e(Input::old('note', $asset->note)); ?></textarea>
            ...
            <div class="box-footer">
              ...
              <button type="submit" class="btn btn-success pull-right"><i class="fa fa-check icon-white"></i> <?php echo e(trans('general.checkin')); ?></button>
            </div>
          </form>
        </div> <!--/.col-md-12-->
      </div> <!--/.box-body-->
