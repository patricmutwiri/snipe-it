                ...
                <div class="box-body">
                    ...
                    <div class="col-md-11 col-md-offset-1">
                        ...
                        <div class="form-group <?php echo e($errors->has('alert_email') ? 'error' : ''); ?>">
                            <div class="col-md-3">
                                <?php echo e(Form::label('alert_email', trans('admin/settings/general.alerts_enabled'))); ?>

                            </div>
                            <div class="col-md-5">
                                <?php echo e(Form::checkbox('alerts_enabled', '1', Input::old('alerts_enabled', $setting->alerts_enabled),array('class' => 'minimal'))); ?>
                        ...
                        <div class="form-group <?php echo e($errors->has('show_alerts_in_menu') ? 'error' : ''); ?>">
                            ...
                            <div class="col-md-5">
                                <?php echo e(Form::checkbox('show_alerts_in_menu', '1', Input::old('show_alerts_in_menu', $setting->show_alerts_in_menu),array('class' => 'minimal'))); ?>
                        ...
                        <div class="form-group <?php echo e($errors->has('alert_email') ? 'error' : ''); ?>">
                            ...
                            <div class="col-md-7">
                                <?php echo e(Form::text('alert_email', Input::old('alert_email', $setting->alert_email), array('class' => 'form-control','placeholder' => 'admin@yourcompany.com'))); ?>

                                <?php echo $errors->first('alert_email', '<span class="alert-msg">:message</span><br>'); ?>
                        ...
                        <div class="form-group <?php echo e($errors->has('alert_interval') ? 'error' : ''); ?>">
                            ...
                            <div class="col-md-9">
                                <?php echo e(Form::text('alert_interval', Input::old('alert_interval', $setting->alert_interval), array('class' => 'form-control','placeholder' => '30', 'maxlength'=>'3', 'style'=>'width: 60px;'))); ?>

                                <?php echo $errors->first('alert_interval', '<span class="alert-msg">:message</span>'); ?>
                        ...
                        <div class="form-group <?php echo e($errors->has('alert_threshold') ? 'error' : ''); ?>">
                            ...
                            <div class="col-md-9">
                                <?php echo e(Form::text('alert_threshold', Input::old('alert_threshold', $setting->alert_threshold), array('class' => 'form-control','placeholder' => '5', 'maxlength'=>'3', 'style'=>'width: 60px;'))); ?>

                                <?php echo $errors->first('alert_threshold', '<span class="alert-msg">:message</span>'); ?>
                        ...
                        <div class="form-group <?php echo e($errors->has('audit_interval') ? 'error' : ''); ?>">
                            ...
                            <div class="input-group col-md-2">
                                <?php echo e(Form::text('audit_interval', Input::old('audit_interval', $setting->audit_interval), array('class' => 'form-control','placeholder' => '12', 'maxlength'=>'3', 'style'=>'width: 60px;'))); ?>

                                <span class="input-group-addon"><?php echo e(trans('general.months')); ?></span>
                            </div>
                            <div class="col-md-9 col-md-offset-3">
                                <?php echo $errors->first('audit_interval', '<span class="alert-msg">:message</span>'); ?>
                        ...
                        <div class="form-group <?php echo e($errors->has('audit_warning_days') ? 'error' : ''); ?>">
                            ...
                            <div class="input-group col-md-2">
                                <?php echo e(Form::text('audit_warning_days', Input::old('audit_warning_days', $setting->audit_warning_days), array('class' => 'form-control','placeholder' => '14', 'maxlength'=>'3', 'style'=>'width: 60px;'))); ?>
                            ...
                            <div class="col-md-9 col-md-offset-3">
                                <?php echo $errors->first('audit_warning_days', '<span class="alert-msg">:message</span>'); ?>
