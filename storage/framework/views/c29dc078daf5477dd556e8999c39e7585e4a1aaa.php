<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title"><?php echo e(trans('admin/models/table.create')); ?></h4>
        </div>
        <div class="modal-body">
            ...
            <div class="dynamic-form-row">
                ...
                <div class="col-md-8 col-xs-12 required"><?php echo e(Form::select('modal-manufacturer', $manufacturer , '', array('class'=>'select2 parent', 'style'=>'width:100%','id' =>'modal-manufacturer_id'))); ?></div>
            </div>

            <div class="dynamic-form-row">
                <div class="col-md-4 col-xs-12"><label for="modal-category_id"><?php echo e(trans('general.category')); ?>:
                    </label></div>
                <div class="col-md-8 col-xs-12 required"><?php echo e(Form::select('modal-category', $category ,'', array('class'=>'select2 parent', 'style'=>'width:100%','id' => 'modal-category_id'))); ?></div>
            </div>
            ...
            <div class="dynamic-form-row">
                ...
                <div class="col-md-8 col-xs-12"><?php echo e(Form::select('custom_fieldset', \App\Helpers\Helper::customFieldsetList(),Input::old('custom_fieldset'), array('class'=>'select2', 'id'=>'modal-fieldset_id', 'style'=>'width:350px'))); ?></div>
            </div>
        </div>
