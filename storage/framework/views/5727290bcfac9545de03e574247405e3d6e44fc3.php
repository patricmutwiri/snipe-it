...
<div class="form-group <?php echo e($errors->has('warranty_months') ? ' has-error' : ''); ?>">
    ...
    <div class="col-md-9">
        <div class="input-group col-md-3" style="padding-left: 0px;">
            <input class="form-control" type="text" name="warranty_months" id="warranty_months" value="<?php echo e(Input::old('warranty_months', $item->warranty_months)); ?>" />
            <span class="input-group-addon"><?php echo e(trans('admin/hardware/form.months')); ?></span>
        </div>
        <div class="col-md-9" style="padding-left: 0px;">
            <?php echo $errors->first('warranty_months', '<span class="alert-msg"><i class="fa fa-times"></i> :message</span>'); ?>
