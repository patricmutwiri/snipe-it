...
<div class="form-group <?php echo e($errors->has('status_id') ? ' has-error' : ''); ?>">
    ...
    <div class="col-md-7 col-sm-11<?php echo e((\App\Helpers\Helper::checkIfRequired($item, 'status_id')) ? ' required' : ''); ?>">
        <?php echo e(Form::select('status_id', $statuslabel_list , Input::old('status_id', $item->status_id), array('class'=>'select2 status_id', 'style'=>'width:100%','id'=>'status_select_id'))); ?>

        <?php echo $errors->first('status_id', '<span class="alert-msg"><i class="fa fa-times"></i> :message</span>'); ?>

    </div>
    <div class="col-md-2 col-sm-2 text-left">
        <a href='<?php echo e(route('modal.statuslabel')); ?>' data-toggle="modal"  data-target="#createModal" data-dependency='statuslabel' data-select='status_select_id' class="btn btn-sm btn-default">New</a>
