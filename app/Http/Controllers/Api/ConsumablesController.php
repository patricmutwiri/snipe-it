...
class ConsumablesController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $allowed_columns = ['id','name','order_number','min_amt','purchase_date','created_at','purchase_cost','company','category','model_number', 'item_no', 'manufacturer','location','qty','image'];
